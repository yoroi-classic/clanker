...
if ! jq -e '
  ...
  and ((.maintenanceWorktreeDays // 14) | nonnegative_integer)
  and ((.maintenanceCheckEnvDays // 7) | nonnegative_integer)
  and ((.maintenancePromptDays // 14) | nonnegative_integer)
  and ((.maintenanceLogDays // 30) | nonnegative_integer)
  and ((.maintenanceLegacyCloneDays // 30) | nonnegative_integer)
  and ((.maintenanceClosedStateDays // 90) | nonnegative_integer)
  and ((.maintenanceTempHours // 24) | nonnegative_integer)
